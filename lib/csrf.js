...
module.exports.generateToken = function(data, secretKey) {
    var dataJSON = JSON.stringify(data);
    var dataString = base64url.encode(dataJSON);
    base64url.encode('wig');
...
module.exports.getCheckedData = function(token, secretKey, options) {
...
module.exports.checkToken = function(token, data, secretKey, options) {
