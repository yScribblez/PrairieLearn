...
class CourseIssueError extends Error {
    constructor(message) {
        ...
        /** @type {any} Any data associated with this error */
        this.data;
        /** @type {boolean} Whether or not this was a fatal error */
        this.fatal;
    }
}

module.exports.CourseIssueError = CourseIssueError;
 ...
 * @param {CourseIssueError[]} courseIssues - List of issue objects for to be written.
 ...
 */
function _writeCourseIssues(client, courseIssues, variant_id, authn_user_id, studentMessage, courseData, callback) {
 ...
 */
function _makeVariant(question, course, options, callback) {
    debug('_makeVariant()');
    var variant_seed;
...
*/
module.exports.getFile = function(filename, variant, question, course, authn_user_id, callback) {
    questionServers.getModule(question.type, (err, questionModule) => {
        if (ERR(err, callback)) return;
        questionModule.file(filename, variant, question, course, (err, courseIssues, fileData) => {
            ...
            _writeCourseIssues(null, courseIssues, variant.id, authn_user_id, studentMessage, courseData, (err) => {
                if (ERR(err, callback)) return;
 ...
 */
function _selectQuestionWithClient(client, question_id, instance_question_id, callback) {
    if (question_id != null) {
 ...
 */
function _makeAndInsertVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, course_instance_id, course, options, callback) {
    _selectQuestionWithClient(client, question_id, instance_question_id, (err, question) => {
        if (ERR(err, callback)) return;
        _makeVariant(question, course, options, (err, courseIssues, variant) => {
            if (ERR(err, callback)) return;
            ...
            sqldb.callWithClientOneRow(client, 'variants_insert', params, (err, result) => {
                ...
                const courseData = {variant, question, course};
                _writeCourseIssues(client, courseIssues, variant.id, authn_user_id, studentMessage, courseData, (err) => {
                    if (ERR(err, callback)) return;
 ...
 * @param {function} callback - A callback(err, variant) function.
 */
function _ensureVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, course_instance_id, course, options, require_open, callback) {
    if (instance_question_id != null) {
        ...
        sqldb.callWithClient(client, 'instance_questions_select_variant', params, (err, result) => {
            ...
            _makeAndInsertVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, course_instance_id, course, options, (err, variant) => {
                if (ERR(err, callback)) return;
 ...
 * @param {function} callback - A callback(err, variant) function.
 */
module.exports.ensureVariant = function(question_id, instance_question_id, user_id, authn_user_id, course_instance_id, course, options, require_open, callback) {
    let variant;
    sqldb.beginTransaction((err, client, done) => {
        ...
        async.series([
            ...
            (callback) => {
                _ensureVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, course_instance_id, course, options, require_open, (err, ret_variant) => {
                    if (ERR(err, callback)) return;
                    variant = ret_variant;
                    callback(null);
                });
 ...
 */
function _saveSubmissionWithClient(client, submission, variant, question, course, callback) {
    ...
    async.series([
        ...
        (callback) => {
            ...
            _writeCourseIssues(client, courseIssues, variant.id, submission.auth_user_id, studentMessage, courseData, (err) => {
                if (ERR(err, callback)) return;
 ...
 * @param {function} callback - A callback(err, submission_id) function.
 */
module.exports.saveSubmission = function(submission, variant, question, course, callback) {
    let submission_id;
    sqldb.beginTransaction((err, client, done) => {
        if (ERR(err, callback)) return;
        async.series([
            ...
            // in the presence of errors.
            (callback) => {
                _saveSubmissionWithClient(client, submission, variant, question, course, (err, ret_submission_id) => {
                    if (ERR(err, callback)) return;
 ...
 *                            committed.
 */
function _gradeVariantWithClient(client, variant, check_submission_id, question, course, authn_user_id, callback) {
 ...
 * @param {function} callback - A callback(err) function.
 */
module.exports.gradeVariant = function(variant, check_submission_id, question, course, authn_user_id, callback) {
    let grading_job_id;
    sqldb.beginTransaction((err, client, done) => {
        if (ERR(err, callback)) return;
        async.series([
            ...
            // in the presence of errors.
            (callback) => {
                _gradeVariantWithClient(client, variant, check_submission_id, question, course, authn_user_id, (err, ret_grading_job_id) => {
                    if (ERR(err, callback)) return;
 ...
 * @param {function} callback - A callback(err, submission_id) function.
 */
module.exports.saveAndGradeSubmission = function(submission, variant, question, course, callback) {
    ...
    sqldb.beginTransaction((err, client, done) => {
        ...
        async.series([
            ...
            (callback) => {
                _gradeVariantWithClient(client, variant, submission_id, question, course, submission.auth_user_id, (err, ret_grading_job_id) => {
                    if (ERR(err, callback)) return;
                    grading_job_id = ret_grading_job_id;
 ...
 * @param {function} callback - A callback(err, submission_id) function.
 */
function _createTestSubmissionWithClient(client, variant, question, course, authn_user_id, callback) {
 ...
 */
function _compareSubmissions(expected_submission, test_submission, callback) {
    const courseIssues = [];
 ...
 * @param {function} callback - A callback(err) function.
 */
function _testVariantWithClient(client, variant, question, course, authn_user_id, callback) {
    debug('_testVariantWithClient()');
    let expected_submission_id, expected_submission, test_submission_id, test_submission;
    async.series([
        (callback) => {
            _createTestSubmissionWithClient(client, variant, question, course, authn_user_id, (err, ret_submission_id) => {
                if (ERR(err, callback)) return;
        ...
        (callback) => {
            _gradeVariantWithClient(client, variant, test_submission_id, question, course, authn_user_id, (err) => {
                if (ERR(err, callback)) return;
        ...
        (callback) => {
            _compareSubmissions(expected_submission, test_submission, (err, courseIssues) => {
                if (ERR(err, callback)) return;
 ...
 * @param {function} callback - A callback(err, variant) function.
 */
function _testQuestion(question, course_instance, course, authn_user_id, callback) {
    debug('_testQuestion()');
    ...
    sqldb.beginTransaction((err, client, done) => {
        ...
        async.series([
            (callback) => {
                ...
                _ensureVariantWithClient(client, question.id, instance_question_id, authn_user_id, authn_user_id, course_instance.id, course, options, require_open, (err, ret_variant) => {
                    if (ERR(err, callback)) return;
                    variant = ret_variant;
            ...
            (callback) => {
                ...
                _testVariantWithClient(client, variant, question, course, authn_user_id, (err, ret_expected_submission, ret_test_submission) => {
                    if (ERR(err, callback)) return;
 ...
 */
function _runTest(logger, showDetails, question, course_instance, course, authn_user_id, callback) {
    let variant, expected_submission, test_submission, success = true;
    async.series([
        (callback) => {
            logger.verbose('Testing ' + question.qid);
            _testQuestion(question, course_instance, course, authn_user_id, (err, ret_variant, ret_expected_submission, ret_test_submission) => {
                if (ERR(err, callback)) return;
                variant = ret_variant;
                expected_submission = ret_expected_submission;
                test_submission = ret_test_submission;
 ...
 */
module.exports.startTestQuestion = function(count, showDetails, question, course_instance, course, authn_user_id, callback) {
    let success = true;
    const options = {
        course_id: course.id,
    ...
    serverJobs.createJobSequence(options, (err, job_sequence_id) => {
        ...
        serverJobs.createJob(jobOptions, (err, job) => {
            ...
            async.eachSeries(_.range(count), (iter, callback) => {
                ...
                _runTest(job, showDetails, question, course_instance, course, authn_user_id, (err, ret_success) => {
                    if (ERR(err, callback)) return;
 ...
 */
function _render(renderSelection, variant, question, submission, submissions, course, course_instance, locals, callback) {
    questionServers.getModule(question.type, (err, questionModule) => {
        if (ERR(err, callback)) return;
        questionModule.render(renderSelection, variant, question, submission, submissions, course, course_instance, locals, (err, courseIssues, htmls) => {
            ...
            _writeCourseIssues(null, courseIssues, variant.id, user_id, studentMessage, courseData, (err) => {
                if (ERR(err, callback)) return;
 ...
 */
function _buildQuestionUrls(urlPrefix, variant, question, instance_question, assessment) {
    const urls = {};

    if (!assessment) {
        // instructor question pages
        const questionUrl = urlPrefix + '/question/' + question.id + '/';
        urls.newVariantUrl = questionUrl;
        urls.tryAgainUrl = questionUrl;
        urls.reloadUrl = questionUrl + '?variant_id=' + variant.id;
...
function _buildLocals(variant, question, instance_question, assessment, assessment_instance) {
    const locals = {};
 ...
 * @param {function} callback - A callback(err) function.
 */
module.exports.getAndRenderVariant = function(variant_id, variant_seed, locals, callback) {
    async.series([
        (callback) => {
            if (variant_id != null) {
                ...
                this.ensureVariant(locals.question.id, instance_question_id, locals.user.user_id, locals.authn_user.user_id, course_instance_id, locals.course, options, require_open, (err, variant) => {
                    if (ERR(err, callback)) return;
        ...
        (callback) => {
            ...
            const urls = _buildQuestionUrls(urlPrefix, variant, question, instance_question, assessment);
        ...
        (callback) => {
            ...
            const newLocals = _buildLocals(variant, question, instance_question, assessment, assessment_instance);
            ...
            sqldb.query(sql.select_submissions, params, (err, result) => {
                ...
                if (result.rowCount >= 1) {
                    locals.submissions = result.rows.map((s) => ({
                        grading_job_stats: _buildGradingJobStats(s.grading_job),
                        ...s,
                    }));
        ...
        (callback) => {
            ...
            _render(renderSelection, locals.variant, locals.question, locals.submission, locals.submissions, locals.course, locals.course_instance, locals, (err, htmls) => {
                if (ERR(err, callback)) return;
...
function _buildGradingJobStats(job) {
    if (job) {
        const phases = [];
...
module.exports.renderPanelsForSubmission = function(submission_id, urlPrefix, questionContext, csrfToken, callback) {
    ...
    sqldb.queryOneRow(sql.select_submission_info, params, (err, results) => {
        ...
        // Fake locals. Yay!
        const locals = _buildQuestionUrls(urlPrefix, variant, question, instance_question, assessment);
        _.assign(locals, _buildLocals(variant, question, instance_question, assessment, assessment_instance));
        ...
        async.parallel([
            (callback) => {
                ...
                // If the submission wasn't graded yet, return null to indicate that
                // the panel shouldn't be rerendered.
                if (submission.graded_at === null) {
                    callback(null);
                }
                const submissions = [submission];

                _render(renderSelection, variant, question, submission, submissions, course, course_instance, locals, (err, htmls) => {
                    if (ERR(err, callback)) return;
                    ...
                    submission.grading_job_stats = _buildGradingJobStats(grading_job);
